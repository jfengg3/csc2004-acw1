...
class main(QWidget):
    ...
    def gui(self):
        ...
        self.hslider2.setValue(NUM_OF_LSB)
    ...
    def changedValue(self):
        NUM_OF_LSB = self.hslider2.value()
        self.ltext2.setText(str(NUM_OF_LSB))
        main.gui.text3.appendPlainText("[Encode] Number of LSB: " + str(NUM_OF_LSB))
        if NUM_OF_LSB > 3:
    ...
    def browsefiles(self, name):
        ...
        if name == 'b3':
            ...
            main.gui.text3.appendPlainText("[Encode] output > " + ENC_IMG_OUT)
        elif name == 'b3ccc':
            ...
            main.gui.text3.appendPlainText("[Decode] output > " + DEC_IMG_OUT)
...
class ImageLabel(QLabel):
    ...
    def dropEvent(self, event):
        if event.mimeData().hasImage:
            ...
            if self.id == 1:
                ENC_IMG_IPT = file_path
                main.gui.ltext1.setText(ENC_IMG_IPT)
                main.gui.text3.appendPlainText("[Encode] input > " + ENC_IMG_IPT)
            elif self.id == 2:
                ENC_IMG_PL = file_path
                main.gui.ltext1_copy.setText(ENC_IMG_PL)
                main.gui.text3.appendPlainText("[Encode] payload > " + ENC_IMG_PL)
            elif self.id == 3:
                DEC_IMG_IPT = file_path
                main.gui.ltext1_copy_copy.setText(DEC_IMG_IPT)
                main.gui.text3.appendPlainText("[Decode] input > " + DEC_IMG_IPT)
